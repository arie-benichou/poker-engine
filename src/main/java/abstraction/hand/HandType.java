...
public enum HandType implements Rankable {
    ...
    public static void main(final String[] args) { // TODO unit tests
        ...
        System.out.println(HandType.HighCard.computeSumOfMaximalHandRanks());
        System.out.println(HandType.HighCard.getDelta());

        System.out.println();

        System.out.println(HandType.OnePair.computeSumOfMaximalHandRanks());
        System.out.println(HandType.OnePair.getDelta());

        System.out.println();

        System.out.println(HandType.TwoPair.computeSumOfMaximalHandRanks());
        System.out.println(HandType.TwoPair.getDelta());

        System.out.println();

        System.out.println(HandType.ThreeOfAKind.computeSumOfMaximalHandRanks());
        System.out.println(HandType.ThreeOfAKind.getDelta());

        System.out.println();

        System.out.println(HandType.Straight.computeSumOfMaximalHandRanks());
        System.out.println(HandType.Straight.getDelta());

        System.out.println();

        System.out.println(HandType.Flush.computeSumOfMaximalHandRanks());
        System.out.println(HandType.Flush.getDelta());

        System.out.println();

        System.out.println(HandType.FullHouse.computeSumOfMaximalHandRanks());
        System.out.println(HandType.FullHouse.getDelta());

        System.out.println();

        System.out.println(HandType.FourOfAKind.computeSumOfMaximalHandRanks());
        System.out.println(HandType.FourOfAKind.getDelta());

        System.out.println();

        System.out.println(HandType.StraightFlush.computeSumOfMaximalHandRanks());
        System.out.println(HandType.StraightFlush.getDelta());
